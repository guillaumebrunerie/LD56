...
export const levels: Level[] = [
	...
	},
	{
		...
		initialAnts: 10,
		targets: [
			{ id: 4, pos: { x: 1920 * 0.3, y: 1080 * 0.25 }, delta: 100 },
			{ id: 4, pos: { x: 1920 * 0.7, y: 1080 * 0.25 }, delta: 100 },
			{ id: 4, pos: { x: 1920 * 0.5, y: 1080 * 0.65 }, delta: 100 },
		],
		sources: [
			{ pos: { x: 1920 * 0.3, y: 1080 * 0.25 }, delta: 100 },
			{ pos: { x: 1920 * 0.7, y: 1080 * 0.25 }, delta: 100 },
			{ pos: { x: 1920 * 0.5, y: 1080 * 0.65 }, delta: 100 },
		],
	...
	},
	{
		...
		sources: [
			{ pos: { x: 1920 * 0.35, y: 1080 * 0.65 }, delta: 100 },
			{ pos: { x: 1920 * 0.35, y: 1080 * 0.25 }, delta: 100 },
			{ pos: { x: 1920 * 0.5, y: 1080 * 0.45 }, delta: 100 },
			{ pos: { x: 1920 * 0.65, y: 1080 * 0.65 }, delta: 100 },
			{ pos: { x: 1920 * 0.65, y: 1080 * 0.25 }, delta: 100 },
		],
