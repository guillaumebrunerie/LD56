...
export const levels: Level[] = [
	...
	},
	{
		...
		sources: [
			{ pos: { x: 1920 * 0.35, y: 1080 * 0.65 }, delta: 0 },
			{ pos: { x: 1920 * 0.35, y: 1080 * 0.25 }, delta: 0 },
			{ pos: { x: 1920 * 0.5, y: 1080 * 0.45 }, delta: 0 },
			{ pos: { x: 1920 * 0.65, y: 1080 * 0.65 }, delta: 0 },
			{ pos: { x: 1920 * 0.65, y: 1080 * 0.25 }, delta: 0 },
		],
